...
<div id="content" class="txt2">
    ...
    <!--<section class="bg2 pad2">
        <div class="container_12">
            <div class="grid_12">
                <h4 class="mrg8">Meet our team</h4>
            </div>
            <ul class="gallery txt">
                <li class="grid_3">
                    <figure class="img1">
                        <a class="lightbox" href="images/page2_big2.jpg"><img class="img5" src="images/page2_img2.jpg" alt=""><span></span></a>
                    </figure><br>
                    <a class="a4" href="#">Bradley Grosh</a>
                    <p class="p4 mrg7">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed dia nonummy nibh euisod.</p>
                </li>
                <li class="grid_3">
                    <figure class="img1">
                        <a class="lightbox" href="images/page2_big3.jpg"><img class="img5" src="images/page2_img3.jpg" alt=""><span></span></a>
                    </figure><br>
                    <a class="a4" href="#">Alan Smith</a>
                    <p class="p4 mrg7">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed dia nonummy nibh euisod.</p>
                </li>
                <li class="grid_3">
                    <figure class="img1">
                        <a class="lightbox" href="images/page2_big4.jpg"><img class="img5" src="images/page2_img4.jpg" alt=""><span></span></a>
                    </figure><br>
                    <a class="a4" href="#">Robert Priston</a>
                    <p class="p4 mrg7">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed dia nonummy nibh euisod.</p>
                </li>
                <li class="grid_3">
                    <figure class="img1">
                        <a class="lightbox" href="images/page2_big5.jpg"><img class="img5" src="images/page2_img5.jpg" alt=""><span></span></a>
                    </figure><br>
                    <a class="a4" href="#">Patrick Pool</a>
                    <p class="p4 mrg7">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed dia nonummy nibh euisod.</p>
                </li>
            </ul>
        </div>
...
<section class="bg2 pad2">
    ...
    <section class="bg2 pad2">
        <div class="container_12">
            <div class="grid_12">
                <h4 class="mrg8">Accreditation</h4>
                <div class="grid_4 alpha">
                    <figure class="mrg10">
                        <img class="img2 img4" src="./images/award/bca.png" alt="">
                    </figure>
                    <!-- <p class="p4 mrg2"><span class="p5">Accreditation 1</span>
                    </p > -->
                </div>
                <div class="grid_4 omega">
                    <figure class="mrg10">
                        <img class="img2 img4" src="./images/award/bizsafe.png" alt="">
                    </figure>
                    <!-- <p class="p4 mrg2"><span class="p5">Accreditation 2</span>
                    </p > -->
                </div>
                <div class="grid_4 omega">
                    <figure class="mrg10">
                        <img class="img2 img4" src="./images/award/ohsas.png" alt="">
                    </figure>
                    <!-- <p class="p4 mrg2"><span class="p5">Accreditation 3</span>
                    </p > -->
                </div>
                <div class="grid_4 omega">
                    <figure class="mrg10">
                        <img class="img2 img4" src="./images/award/prestige.png" alt="">
                    </figure>
                    <!-- <p class="p4 mrg2"><span class="p5">Accreditation 3</span>
                    </p > -->
                </div>
                <div class="grid_4 omega">
                    <figure class="mrg10">
                        <img class="img2 img4" src="./images/award/sac.png" alt="">
                    </figure>
                    <!-- <p class="p4 mrg2"><span class="p5">Accreditation 3</span>
                    </p > -->
                </div>
