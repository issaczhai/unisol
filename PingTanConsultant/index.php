		    		...
		    		<div id="carousel-index" class="carousel slide" data-ride="carousel" >
		                ...
		                <div class="carousel-inner" >
		                    <div class="item active">
		                        <img src="./public_html/img/index-banner1.png">
		                    </div>
		                    <div class="item">
		                        <img src="./public_html/img/index-banner1.png">
		                    </div>
	    ...
	    <div class="container">
	    	<div class="row award">
	    		<div class="col-md-2 col-center">
	    			<h4 class="text-default">OUR AWARDS</h4>
	    		</div>

	    		<div class="col-md-6 col-center certificate-award">
	    			<div class="col-md-4">
	    	...
	    	<div class="row course">
	    		<div class="col-md-2 col-center">
	    			<h4 class="text-default">OUR COURSES</h4>
	    		</div>
	    		<div class="col-md-12">
