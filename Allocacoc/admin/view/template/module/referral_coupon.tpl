  ...
  <div class="container-fluid">
            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-left">
                    <?php echo $r['referrer']; ?>
                    [ <a href="index.php?route=sale/customer/edit&token=<?php echo $token; ?>&customer_id=<?php echo $r['referrer_id']; ?>" target="_blank"><?php echo $lng['button_edit']; ?></a> ]
                  </td>
                  <td class="text-left">
                    <?php echo $r['referee']; ?>
                    <?php if ($r['referee_id']) { ?>
                    [ <a href="index.php?route=sale/customer/edit&token=<?php echo $token; ?>&customer_id=<?php echo $r['referee_id']; ?>" target="_blank"><?php echo $lng['button_edit']; ?></a> ]
                    <?php } ?>
                  </td>
    ...
    <div class="row" id="upgrade">Upgrade:
      <ol>
        ...
        <li><a href="index.php?route=module/referral_coupon/install&token=<?php echo $token; ?>">Complete upgrade process</a></li>
      </ol>
