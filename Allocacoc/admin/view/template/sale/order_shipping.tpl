...
<div class="container">
  ...
  <div style="page-break-after: always;">
    ...
    <table class="table table-bordered">
      <thead>
        <tr>
          <td style="width: 50%;border: solid"><b><?php echo $text_to; ?></b></td>
          <td style="width: 50%;border: solid"><b><?php echo $text_contact; ?></b></td>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td style="border: solid"><?php echo $order['shipping_address']; ?></td>
          <td style="border: solid"><?php echo $order['telephone']; ?></td>
        </tr>
      </tbody>
    </table>
    <table class="table table-bordered">
