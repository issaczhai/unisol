...
<div id="page">
    <header>
        ...
        <div class="menu-line">
            ...
            <div class="fright">
                <?php if ($logged) { ?>
                    <a class="login" href="<?php echo $logout; ?>"><i class="material-icons-lock_open"></i><?php echo $text_logout; ?></a>
                <?php }else{?>
                    <a class="login" href="<?php echo $login; ?>"><i class="material-icons-vpn_key"></i><?php echo $text_login; ?>
                    </a>
                <?php }?>
            </div>
            </div>
