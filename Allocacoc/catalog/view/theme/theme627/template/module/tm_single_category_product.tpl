                                ...
                                foreach ($featured_products as $product) {
									...
									<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i>
                                        ...
                                        <div class="quick_info">
                                            <div id="quickview_<?php echo $tf . $module; ?>" class="quickview-style">
                                                <div>
                                        ...
                                        <div class="image">
                                            ...
                                            <a class="quickview" data-rel="details" href="#quickview_<?php echo $tf . $module; ?>">
                                                <?php echo $text_quick; ?>
                                            </a>
                                        </div>
                                        <div class="caption">
                            ...
                            <div class="tab-carousel">
                                ...
                                foreach ($special_products as $product) {
									...
									<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i>
                                        ...
                                        <div class="quick_info">
                                            <div id="quickview_specials_<?php echo $tc . $module; ?>" class="quickview-style">
                                                <div>
                                                    <div class="left col-sm-4">
                                                        <div class="quickview_image image">
                                                            <a href="<?php echo $product['href']; ?>"><img
                                        ...
                                        <div class="image">
                                            ...
                                            <a class="quickview" data-rel="details" href="#quickview_specials_<?php echo $tc . $module; ?>">
                                                <?php echo $text_quick; ?>
                                            </a>
                                        </div>
                                        <div class="caption">
                            ...
                            <div class="tab-carousel">
                                ...
                                foreach ($bestseller_products as $product) {
									...
									<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i>
                                        ...
                                        <?php } ?>
                                        <div class="quick_info">
                                            <div id="quickview_bestsellers_<?php echo $tb . $module; ?>" class="quickview-style">
                                                <div>
                                                    <div class="left col-sm-4">
                                                        <div class="quickview_image image">
                                                            <a href="<?php echo $product['href']; ?>"><img
                                        ...
                                        <div class="image">
                                            ...
                                            <a class="quickview" data-rel="details" href="#quickview_bestsellers_<?php echo $tb . $module; ?>">
                                                <?php echo $text_quick; ?>
                                            </a>
                                        </div>
                                        <div class="caption">
