<?php if (empty($show)) { ?>
    <div id="tm-newsletter-popup" class="newsletter-popup-wrap">
        <div class="newsletter-popup">
            <div class="bg-image" <?php if (isset($popup_bg)) { ?> style="background-image: url(<?php echo $popup_bg;?>)"<?php }?>></div>
            ...
            <div class="box-content">
                ...
                <form method="post" enctype="multipart/form-data" id="tm-newsletter-popup-form">
                    <div class="tm-login-form">
                        ...
                        <button type="submit" id="tm-newsletter-popup-button" class="newsletter-popup-btn"><?php echo $button_subscribe; ?></button>
            ...
            <a href="#" id="newsletter-popup-close-btn"
                    class="newsletter-popup-close-btn material-icons-clear"></a>
